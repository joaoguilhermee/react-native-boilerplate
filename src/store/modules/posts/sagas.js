...
import { GET_POSTS_REQUEST, ADD_POSTS_REQUEST, getPostsSuccess, getPostsFailure, addPostsSuccess } from './actions';
...
export default all([takeLatest(GET_POSTS_REQUEST, getPosts), takeLatest(ADD_POSTS_REQUEST, addPosts)]);
